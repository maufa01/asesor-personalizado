...
ASSET_UNIVERSE: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "volatility": 0.06,
        "risk_level": "bajo",
        "description": "TX28 (vence julio 2028): bono del Tesoro que ajusta por el índice de inflación (CER) más una tasa extra. Si la inflación es 100%, este bono vale 100% más. Es la mejor cobertura en pesos contra la inflación. Comprable en IOL, PPI o Balanz.",
        "currency": "ARS",
        "market": "BYMA",
